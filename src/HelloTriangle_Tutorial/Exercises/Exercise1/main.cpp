/*
EXERCISE 1:
- Modify the vertex data to draw two triangles side by side to form a rectangle.
*/
...
int main() {
  ...
  float vertices[] = {// First triangle
                      -0.9f, -0.5f, 0.0f, -0.5f, 0.5f, 0.0f, -0.1f, -0.5f, 0.0f,
                      // Second triangle
                      0.1f, -0.5f, 0.0f, 0.5f, 0.5f, 0.0f, 0.9f, -0.5f, 0.0f};
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    glBindVertexArray(VAO); // Technically unnecessary every frame, since we
                            // only have a single VAO, but we'll do it anyway
